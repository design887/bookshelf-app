...
function LandingPage({ signIn }) {
  ...
  return (
    <div style={{
      height: "100vh", background: "#fdf5f5",
      display: "flex", flexDirection: "column",
      ...
      <div style={{
        ...
        <span style={{
          fontFamily: "'Instrument Serif', serif", fontSize: isMobile ? 20 : 22,
          fontStyle: "italic", fontWeight: 400, color: "#111", letterSpacing: "-.3px",
        }}>bookshelf</span>
        <button
          onClick={signIn}
          style={{
          ...
          onMouseEnter={e => { e.currentTarget.style.background = "#111"; e.currentTarget.style.color = "#fdf5f5"; }}
      ...
      <div style={{
        ...
        alignItems: "center", justifyContent: "center",
        padding: isMobile ? "0 28px 100px" : "0 40px 100px",
        textAlign: "center",
      }}>
        {/* Giant headline */}
        <h1 style={{
          fontFamily: "'Instrument Serif', serif",
          fontSize: isMobile ? "clamp(48px, 14vw, 72px)" : "clamp(64px, 8vw, 120px)",
          fontWeight: 400, fontStyle: "italic",
          lineHeight: .95, letterSpacing: "-2px",
          color: "#111", margin: 0,
          maxWidth: 900,
          animation: "scaleIn .6s ease .1s both",
        }}>
          Your books,<br/>
          <span style={{ color: "#c9707d" }}>beautifully kept</span>
        </h1>
        ...
        <p style={{
          ...
          Track your reading, build your collection,<br/>
          and see your shelves come to life.
        </p>
        ...
        <button
          ...
          style={{
            ...
            color: "#fdf5f5", fontSize: isMobile ? 15 : 16, fontWeight: 500,
      ...
      <div style={{
        ...
        animation: "fadeIn .5s ease .55s both",
      }}>
        <span style={{
          fontSize: 12, fontWeight: 400,
          color: "rgba(0,0,0,.25)", letterSpacing: ".3px",
        }}>Free forever · Your data stays yours</span>
      </div>
    </div>
  );
}
